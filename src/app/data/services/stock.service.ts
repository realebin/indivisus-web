...
import { BigPackageModel, SmallPackageModel, StockHeaderModel, transformToBigPackageModel, transformToSmallPackageModel, transformToStockCreateRequest, transformToStockHeaderModel, transformToStockUpdateRequest } from '@models/stock.model';
...
export class StockManagementService {
  ...
  // Big Package Methods
  createBigPackage(stockId: string, bigPackageData: {
    packageNumber: string;
    sizeDescription: string;
    smallPackages: {
      sizeAmount: number;
    ...
    return this.stockManagementHttpService.createBigPackage(stockId, {
  ...
  updateBigPackage(bigPackageData: {
    ...
    return this.stockManagementHttpService.updateBigPackage({
      package_number: bigPackageData.packageNumber,
      size_description: bigPackageData.sizeDescription,
  ...
  markBigPackageAsOpen(packageNumber: string, changedBy: string): Observable<any> {
    return this.stockManagementHttpService.markBigPackageAsOpen(packageNumber, changedBy).pipe(
      map(response => response.output_schema),
      catchError((error: ErrorOutputWrapper<any>) => {
        return throwError(() => error);
      })
  ...
  createSmallPackage(packageNumber: string, smallPackageData: {
    sizeAmount: number;
    sizeDescription: string;
    createdBy: string;
  }): Observable<SmallPackageModel> {
    return this.stockManagementHttpService.createSmallPackage(packageNumber, {
  ...
  updateSmallPackage(smallPackageData: {
    ...
    return this.stockManagementHttpService.updateSmallPackage({
  ...
  markSmallPackageAsOpen(packageId: string, changedBy: string): Observable<any> {
    return this.stockManagementHttpService.markSmallPackageAsOpen(packageId, changedBy).pipe(
      map(response => response.output_schema),
      catchError((error: ErrorOutputWrapper<any>) => {
        return throwError(() => error);
      })
